			...
			<TD width="100%">
				...
				<legend>添加菜品</legend>
					  ...
					  <tr>
					    ...
					    <tr>
					    <td nowrap align="right" width="11%">菜品ID:</td>
					    <td width="27%"><input name='foodId' type="text" class="text" style="width:154px" value="" /></td>

					    <td align="right" width="30%">&nbsp;</td>
					    <td width="50%">&nbsp;</td>
					    </tr>
                      <tr>
					    <td  width="11%" nowrap align="right">其他要求:</td>
...
if($submit=$_POST['submit']){
	$userId=$_POST['userId'];
	$foodId=$_POST['foodId'];
	$sql="Insert into diningcar(userId,foodId) values ('$userId','$foodId')" ;
	mysql_query($sql);
