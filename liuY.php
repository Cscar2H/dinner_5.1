...
//<---end用户状态判断--->
if ($_SESSION['ident'] == 1) {
  $url = "http://localhost/dinner/index1.php"; 
}else{
  $url = "http://localhost/dinner/index.php"; 
}
?>
<!doctype html>
<html>
...
<table width="1238" height="500" border="0">
  ...
  <tr>
    ...
    <table width="368" height="299" border="0">
      <tr>
        <td width="350" height="28" style="color: #4394F5; font-style: normal; font-weight: bold; font-size: 20px;">留言</td>
      </tr>
     
      <tr>
        
         <td colspan="3"> <strong>我的意见是：</strong><textarea name="text" cols="70" rows="10"></textarea></td>
      </tr>
       
      <tr>
        <td colspan = "2" height="40"><input type="submit" name="submit" id="submit" class="btn btn-primary" value="确认评价" style="width:100px;" onclick="return login();">&nbsp;&nbsp;&nbsp;&nbsp;
          <a href='liuY_2.php'>
         <input type="button" name="button" id="button" class="btn btn-primary" value="留言板" style="width:100px;" align="right"></a>
         &nbsp;&nbsp;&nbsp;&nbsp; 
        <a href='<?php echo $url;?>'>
